...
const ia = (t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1749278704000 > "u")) {
      var e, i;
      setInterval(() => {
        !t.$destroyed && Date.now() - 1749278704000 > 5184e6 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
...
`);
    if (typeof 1749278704000 > "u") return;
    const e = function() {
      var i, a;
      setTimeout(() => {
        Date.now() - 1749278704000 > 7776e6 && window.alert(n), e();
...
Y.gantt = Ur, Y.Gantt = Be, Be.plugin((t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1749278704000 > "u")) {
      var e, i;
      setInterval(() => {
        !t.$destroyed && Date.now() - 1749278704000 > 27648e5 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
